...
export const SidebarNavigationSectionDividers = ({ activeUrl, items }: SidebarNavigationSectionDividersProps) => {
    ...
    const content = (
        <aside
            ...
            className="flex h-full w-full max-w-full flex-col justify-between overflow-auto border-secondary bg-primary pt-4  md:border-r lg:w-(--width) lg:rounded-xl lg:border lg:pt-5"
        >
