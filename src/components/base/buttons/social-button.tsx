...
export const styles = sortCx({
    ...
    colors: {
        ...
        dribble: {
            root: "bg-[#EA4C89] text-white  ring-1 ring-transparent ring-inset before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0% hover:bg-[#E62872]",
            icon: "",
        },
    },
});
